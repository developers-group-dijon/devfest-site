...
export default [
  // pauses
  {
    id: "pause midi",
    title: "Pause repas",
    dateStart: new Date("2024-12-06T12:45:00.000+01:00"),
    durationMinutes: 75,
  },
  {
    id: "pause matin",
    title: "Pause",
    dateStart: new Date("2024-12-06T10:40:00.000+01:00"),
    durationMinutes: 20,
  },
  {
    id: "pause apres-midi",
    title: "Pause",
    dateStart: new Date("2024-12-06T15:45:00.000+01:00"),
    durationMinutes: 20,
  },
  // keynotes
  {
    ...
    dateStart: new Date("2024-12-06T09:00:00.000+01:00"),
    durationMinutes: 20,
  },
  // keynotes
  {
    ...
    dateStart: new Date("2024-12-06T17:25:00.000+01:00"),
    durationMinutes: 20,
  },
  // sessions
  {
    ...
    dateStart: new Date("2024-12-06T09:25:00.000+01:00"),
    durationMinutes: 50,
    speakerIds: ["marine-du-mesnil", "paul-molin"],
    trackId: "amphi-1",
    trackRange: null,
    language: "French",
    level: "intermediate",
  ...
  },
  {
    ...
    dateStart: new Date("2024-12-06T10:20:00.000+01:00"),
    durationMinutes: 20,
    speakerIds: ["julien-libert"],
    trackId: "amphi-1",
    trackRange: null,
    language: "French",
    level: "intermediate",
  ...
  },
  {
    ...
    dateStart: new Date("2024-12-06T11:00:00.000+01:00"),
    durationMinutes: 50,
    speakerIds: ["christophe-gigax"],
    trackId: "amphi-1",
    trackRange: null,
    language: "French",
    level: "intermediate",
  ...
  },
  {
    ...
    dateStart: new Date("2024-12-06T14:00:00.000+01:00"),
    durationMinutes: 50,
    speakerIds: ["bertrand-delacretaz"],
    trackId: "amphi-1",
    trackRange: null,
    language: "French",
    level: "beginner",
  ...
  },
  {
    ...
    dateStart: new Date("2024-12-06T14:55:00.000+01:00"),
    durationMinutes: 50,
    speakerIds: ["nicolas-frankel"],
    trackId: "amphi-2",
    trackRange: null,
    language: "French",
    level: "beginner",
  ...
  },
  {
    ...
    dateStart: new Date("2024-12-06T16:05:00.000+01:00"),
    durationMinutes: 20,
    speakerIds: ["thierno-diallo"],
    trackId: "amphi-1",
    trackRange: null,
    language: "French",
    level: "intermediate",
  ...
  },
  {
    ...
    dateStart: new Date("2024-12-06T11:55:00.000+01:00"),
    durationMinutes: 50,
    speakerIds: ["arnaud-pichery"],
    trackId: "amphi-1",
    trackRange: null,
    language: "French",
    level: "beginner",
  ...
  },
  {
    ...
    dateStart: new Date("2024-12-06T16:30:00.000+01:00"),
    durationMinutes: 50,
    speakerIds: ["yann-jacquot", "alexis-stefanski"],
    trackId: "amphi-3",
    trackRange: null,
    language: "French",
    level: "intermediate",
  ...
  },
  {
    ...
    dateStart: new Date("2024-12-06T10:20:00.000+01:00"),
    durationMinutes: 20,
    speakerIds: ["jacqueline-rwanyindo"],
    trackId: "amphi-2",
    trackRange: null,
    language: "French",
    level: "beginner",
  ...
  },
  {
    ...
    dateStart: new Date("2024-12-06T11:00:00.000+01:00"),
    durationMinutes: 50,
    speakerIds: ["guillaume-blaquiere"],
    trackId: "amphi-3",
    trackRange: null,
    language: "French",
    level: "intermediate",
